...
varnames = {'cos_area', 'corr_cos_area',...
    ...
    'corr_cos2_area_abs', 'cos2_area_abs', 'hd_efn', 'fixed_pss', 'hd_svn', 'fixed_nsv', 'hd_nsv_fixed', 'hd_pss_fixed', 'overlap_metric', 'var_fwhm_cm', 'var_fwhm_cm_pj', 'var_fwhm_cm_filt', 'var_fwhm_cm_pj_filt'};
