function transient_canvas = one_time_events( traces )
...
traces = traces.';
%parameters
params.med_window_size = 101;%201;
params.avg_window_size = 3;%5;
params.z = 1.5;
params.width = 5;%10;
params.sep = 4;%7;
params.offset_delay = 0;
...
for ix = 1:num_peaks
    ...
    if (start_of_transient >= 1) && (end_of_transient >= 1)
        ...
        transient_canvas(floor((start_of_transient + end_of_transient)/2),j) = 1;
    end
end
...
transient_canvas = transient_canvas.';
end