...
% $Id: export_fig.m,v 1.1 2009/06/20 21:55:40 stootoon Exp $

function [im alpha] = export_fig_opengl(varargin)
...
if isbitmap(formats)
    ...
    if formats.jpg
        imwrite(A, [name '.jpg'], 'Quality', 100);
    end
end
...
if isvector(formats)
    ...
    try
        % Generate an eps
        print2eps(tmp_nam, fig, 'printMode','opengl');
        % Generate a pdf
