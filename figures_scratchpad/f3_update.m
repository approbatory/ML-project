...
p.panel(2,...
    ...
    'ylab', '{\itI}_0 fit value');
org.correlogram('single_dp2', 'I0', true, false);
p.format;
...
p.panel(3,...
    'xlab', 'Asymptotic SNR',...
    'ylab', sprintf('Asymptotic IMSE\nfit value'));
org.correlogram('asymp_snr', 'I0N', true, false);
...
p.panel(6,...
    ...
    'ylab', '1/{\itN} fit value');
name = sprintf('delta_cos2_area_%d', MAX_DIM);
org.correlogram(name, 'invN50', true, true);
Nvals = [200 100 65 50];
